function genPerfMat_seperate(seqs, trackers, evalType, nameTrkAll, perfMatPath)
...
dataName1=[perfMatPath 'aveSuccessRatePlot_' seqs{1}.name '_' num2str(numTrk) 'alg_overlap_' evalType '.mat'];
...
dataName2=[perfMatPath 'aveSuccessRatePlot_' seqs{1}.name '_' num2str(numTrk) 'alg_error_' evalType '.mat'];
