...
trackersTest = {
    struct('name','mxnet','namePaper','reproduced_mxnet'),...
	struct('name','epoch_1','namePaper','epoch_1'),...
    struct('name','epoch_1_ignore','namePaper','epoch_1_ignore'),...
    struct('name','epoch_2','namePaper','epoch_2'),...
    struct('name','epoch_3','namePaper','epoch_3'),...
    struct('name','pretrained','namePaper','pretrained_imagenet'),...
