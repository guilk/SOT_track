...
if __name__ == '__main__':
    ...
    saveRoot = '../results/mxnet_epicflow_dynamic/'
    if not os.path.exists(saveRoot):
        os.makedirs(saveRoot)
    img_save_root = './ori_imgs'
    ...
    sym, arg_params, aux_params = mx.model.load_checkpoint(os.path.join(model_dir,'SINT'),epoch_index)
    ...
    for vid in range(num_videos):
        ...
        for id in frameidx:
            ...
            im_tmp = cv2.imread(framepath)
            img_draw = cv2.resize(im_tmp, (imageSz, imageSz),
