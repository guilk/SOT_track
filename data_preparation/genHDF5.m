...
srcRoot = '/data01/ALOV/train_metafile_for_gen_hdf5_trial01';
...
%     sprintf('hdf5_files/train_hdf5_part%03d_perblock%d_nr_ang16_r_step10_IoU_p0.7_n0.5_64boxesperim.h5', i, block_size)
    ...
    for jj = 1:num
        ...
        impath = sprintf('/data01/ALOV/images/%s/%s_%s/%s', image_info_1_part{jj}(1:pos(1)-1), image_info_1_part{jj}(1:pos(1)-1), image_info_1_part{jj}(pos(1)+1:pos(2)-1), image_info_1_part{jj}(pos(2)+1:end));
        ...
        impath = sprintf('/data01/ALOV/images/%s/%s_%s/%s', image_info_2_part{jj}(1:pos(1)-1), image_info_2_part{jj}(1:pos(1)-1), image_info_2_part{jj}(pos(1)+1:pos(2)-1), image_info_2_part{jj}(pos(2)+1:end));
        im = imread(impath); w = size(im,2); h = size(im,1);
...
%     h5filename = sprintf('hdf5_files/train_hdf5_part%03d_perblock%d_nr_ang16_r_step10_IoU_p0.7_n0.5_64boxesperim.h5', i, block_size);
    h5filename = sprintf('/data01/ALOV/hdf5_files/train_hdf5_imsz%d_part%03d_perblock%d_nr_ang16_r_step10_IoU_p0.7_n0.5_64boxesperim.h5', imageSz, i, block_size);
